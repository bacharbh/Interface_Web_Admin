...
// Import models using dynamic import since they use CommonJS
const TelemetryData = (await import('../backend/models/TelemetryData.js')).default;
const Sheep = (await import('../backend/models/Sheep.js')).default;
