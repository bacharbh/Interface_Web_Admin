...
Le dashboard Smart Shepherd fournit une surveillance temps réel complet du troupeau avec des métriques de performance, des alertes intelligentes et des visualisations de données interactives.
\end{tcolorbox}
...
\begin{itemize}
    ...
    \item \textbf{Actions Rapides :} Marquer comme lu, Détails, Supprimer
\end{itemize}
\end{tcolorbox}
...
\hline
MQTT Connecté & \textcolor{accentgreen}{\faIcon{check-circle}} & Communication temps réel active \\
...
\begin{itemize}
    ...
    \item \textbf{Impact Troupeau :} Recommandations basées sur météo
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
    ...
    \item \textbf{Mode Sombre :} Réduction fatigue oculaire
