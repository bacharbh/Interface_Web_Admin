...
const AddEventModal: React.FC<Props> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <form onSubmit={handleSubmit} className="relative z-10 w-full max-w-3xl rounded-2xl bg-white p-6 shadow-lg dark:bg-gray-900">
                <h3 className="title-sm mb-4">{initialEvent ? 'Modifier un événement' : 'Ajouter un événement vétérinaire'}</h3>

                {errors.length > 0 && (
                    <div className="mb-4 rounded-xl border border-red-200 bg-red-50 p-3 text-sm text-red-700 dark:border-red-500/30 dark:bg-red-500/10 dark:text-red-100">
                        {errors.map((error) => (
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="col-span-2">
                        ...
                        />
                        <div className="mt-2 max-h-40 overflow-auto rounded-xl border border-gray-200 bg-gray-50 p-2 dark:border-gray-800 dark:bg-gray-950">
                    ...
                    <label className="col-span-2">
                        Notes
                        <textarea className="w-full mt-1 p-2 rounded-lg" value={notes} onChange={(event) => setNotes(event.target.value)} rows={4} />
                    </label>
                </div>
